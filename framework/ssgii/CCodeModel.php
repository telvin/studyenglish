...
abstract class CCodeModel extends CFormModel
{
	...
	public function getTemplates()
	{
        ...
        //var_dump(Yii::getPathOfAlias('ssgii.generators.model.templates.default') . DIRECTORY_SEPARATOR. 'model.php');
        return Yii::app()->controller->templates;

        /*
        $modelTemplates = array(
          'default' => Yii::getPathOfAlias('ssgii.generators.model.templates.default')
        );
	...
	{
		return Yii::app()->runtimePath.'/ssgii-'.Yii::getVersion().'/'.get_class($this).'.php';
	}
